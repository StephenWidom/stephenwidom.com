        ...
        <BrowserRouter>
            <div>
                ...
                <Switch>
                    ...
                    <Route path="/technologies" render={(props) => <Technologies {...props} colors={colors} technologies={technologies} scale={scale} updateCache={updateCache} />} />
                    <Route path="/skills" render={(props) => <Skills {...props} colors={colors} skills={skills} scale={scale} updateCache={updateCache} />} />
